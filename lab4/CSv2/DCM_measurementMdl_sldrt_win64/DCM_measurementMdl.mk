...
MODEL                := DCM_measurementMdl
MODULES              := DCM_measurementMdl_data.c DCM_measurementMdl_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := DCM_measurementMdl.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := DCM_measurementMdl_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/RTP;C:/RTP/DCM_measurementMdl_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
