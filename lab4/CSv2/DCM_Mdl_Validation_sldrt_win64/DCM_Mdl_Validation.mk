...
MODEL                := DCM_Mdl_Validation
MODULES              := DCM_Mdl_Validation_data.c DCM_Mdl_Validation_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := DCM_Mdl_Validation.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := DCM_Mdl_Validation_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/RTP;C:/RTP/DCM_Mdl_Validation_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
